...
export default function Footer() {
  ...
  return (
    <footer className="footer position-relative pt-5 pb-4 overflow-hidden" style={{ backgroundColor: "#f4f8fb" }}>
      {/* Faint Background Image */}
      <div 
        className="position-absolute w-100 h-100 top-0 start-0" 
        style={{
          backgroundImage: "url('/images/teamwork.png')", /* Using the teamwork image as the faint medical background */
      ...
      <div className="container position-relative pt-4" style={{ zIndex: 1 }}>
        <div className="row justify-content-between g-5">
          ...
          <div className="col-12 col-md-4 col-lg-3">
            ...
            <p className="text-muted mb-5 pe-md-3 fw-medium" style={{ lineHeight: "1.8", fontSize: "1.05rem" }}>
              Automate and simplify your dental practice operations with secure and efficient billing solutions.
            </p>
            ...
            <div className="d-flex gap-2 mb-4">
              {[
                ...
                <a
                  ...
                  style={{ width: "35px", height: "35px", backgroundColor: "#13a195", transition: "transform 0.2s" }}
            ...
            <ul className="list-unstyled d-flex flex-column gap-3 mb-0">
              {[
                ...
                <li key={item.label} className="d-flex align-items-center gap-2">
                  <i className="fa-solid fa-angle-right" style={{ color: "#13a195", fontSize: "0.85rem" }}></i>
                  <Link
                    href={item.href}
          ...
          <div className="col-12 col-md-12 col-lg-3 mt-5 mt-lg-0">
            ...
            <ul className="list-unstyled d-flex flex-column gap-4 mb-0">
              <li className="d-flex align-items-start gap-3">
                <i className="fa-solid fa-phone mt-1" style={{ color: "#13a195", width: "20px" }}></i>
                <a href="tel:+14754346464" className="text-decoration-none text-muted fw-medium hover-focus-teal" style={{ transition: "color 0.2s" }}>
                  (475) 434-6464
                </a>
              </li>
              <li className="d-flex align-items-start gap-3">
                <i className="fa-regular fa-envelope mt-1" style={{ color: "#13a195", width: "20px" }}></i>
                <a href="mailto:admin@dentalbilingteam.com" className="text-decoration-none text-muted fw-medium text-break hover-focus-teal" style={{ transition: "color 0.2s" }}>
                  admin@dentalbilingteam.com
                </a>
              </li>
              <li className="d-flex align-items-start gap-3">
                <i className="fa-solid fa-location-dot mt-1" style={{ color: "#13a195", width: "20px" }}></i>
                <span className="text-muted fw-medium">Brookfield, CT 06804</span>
              </li>
              <li className="d-flex align-items-start gap-3">
                <i className="fa-regular fa-clock mt-1" style={{ color: "#13a195", width: "20px" }}></i>
                <div className="text-muted fw-medium">
                  Mon-Fri : 8:00 am-9:00pm
                  <span className="d-block mt-3">Saturday 8:00 am to 8:00 pm</span>
        ...
        <div className="mt-5 pt-4 pb-2" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
          <div className="row flex-column-reverse flex-md-row align-items-center">
            <div className="col-12 col-md-6 text-center text-md-start text-muted fw-medium mt-3 mt-md-0">
              Copyright &copy; {currentYear !== 2026 ? '2026' : currentYear} DBT. All Rights Reserved.
            </div>
            <div className="col-12 col-md-6 d-flex justify-content-center justify-content-md-end gap-3 text-muted fw-medium">
              <Link href="#" className="text-decoration-none text-muted hover-focus-teal">Terms &amp; Service</Link>
              <span>|</span>
              <Link href="#" className="text-decoration-none text-muted hover-focus-teal">Privacy Policy</Link>
            </div>
          </div>
        </div>
      </div>
