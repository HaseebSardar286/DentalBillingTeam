      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="fs-6 fw-medium text-white">Patient Billing</span>
          </div>
          ...
          >
            Streamlined Dental Patient Billing & Credentialing Solutions
          </h1>
          <p
          ...
          >
            Simplify patient billing with clear, accurate invoicing and support.
            Our dental billing solutions reduce confusion and speed up payments.
          </p>
          ...
          <div className="d-flex justify-content-center gap-3">
            ...
            >
              Get Started with Patient Billing
            </Link>
          </div>
        </div>
        ...
        <div className="container py-5 mt-4">
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              ...
              >
                <p className="mb-4">
                  We handle overdue patient balances with consistent statements,
                  letters, and calls, and refer uncollectible accounts to the
                  office for collection or closure.
                </p>
                <p className="mb-4">
                  Statements are sent weekly, audited for accuracy, and
                  delivered every 30 days via your practice management software.
                </p>
                <p className="mb-4">
                  We reach out with compassion to patients 60, 90, and 90+ days
                  overdue, using tailored letters and calls with a custom phone
                  number for your practice, to ensure timely resolution of
                  overdue balances.
                </p>
                <p className="mb-4">
                  We also support practices with essential fee schedule updates
                  to ensure that your billing is in alignment with the most
              ...
              >
                ...
                <div className="d-flex flex-column gap-4">
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Customized patient letters and phone calls
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Patient aging reports consistently managed
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
              ...
              >
                ...
                <div className="d-flex flex-column gap-4">
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Make dental patient billing smooth and stress-free
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      No more chasing payments at the front desk
                    </span>
                  </div>
                </div>
              </div>
