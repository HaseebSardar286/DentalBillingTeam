      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="fs-6 fw-medium text-white">A/R Management</span>
          </div>
          ...
          >
            Recover Aging Dental Insurance Claims
          </h1>
          <p
          ...
          >
            Struggling with aging dental insurance claims? We help recover
            unpaid claims and reduce AR days with expert follow-up and support.
          </p>
          ...
          <div className="d-flex justify-content-center gap-3">
            ...
            >
              Get Started with A/R Management
            </Link>
          </div>
        </div>
        ...
        <div className="container py-5 mt-4">
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              ...
              >
                <p className="mb-4">
                  Immediate follow-up on claims starting at 30 days past due to
                  minimize delays and ensure timely resolution.
                </p>
                <p className="mb-4">
                  Consistent tracking and follow-up every 14-21 days, so nothing
                  falls through the cracks.
                </p>
                <p className="mb-4">
                  Skilled handling of every denial and appeal, fighting
                  tirelessly to ensure you receive every dollar you’re
                  rightfully owed and never giving up until your claims are paid
                  in full.
                </p>
                <p className="mb-4">
                  Clear, detailed status updates directly entered into your
                  dental software for complete visibility and easy tracking.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="d-flex flex-column gap-4">
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Prevent aging claims from slowing down your practice
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
