    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Fast and Accurate Dental Insurance Verification Services
          </h1>
          <p
          ...
          >
            Tired of claim delays? We offer fast, accurate dental insurance
            verification services to help your practice get paid faster.
          </p>
        ...
        <div className="container py-5 mt-4">
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              ...
              >
                <p className="mb-4">
                  We offer full breakdowns for yearly plan changes, complete
                  insurance details for accurate treatment planning, and custom
                  code-specific questions tailored to your practice.
                </p>
                <p className="mb-4">
                  We provide dependable eligibility checks, confirmation of
                  active coverage, and updates to maximums and deductibles for
                  plans with completed breakdowns for the benefit year.
                </p>
                <p className="mb-4">
                  We offer flexible package options, including a full schedule
                  for all patients, hygiene-only breakdowns, and new patient
                  breakdowns for accurate planning.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="d-flex flex-column gap-4">
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Updates to maximums and and deductibles
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Flexible package options (hygiene-only, new patients)
                    </span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="d-flex flex-column gap-4">
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Prevent verification delays from impacting your practice
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Provide patients with accurate estimates
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Increase case acceptance through transparent coverage
                    </span>
                  </div>
                  <div
                    className="d-flex align-items-center p-3 rounded-4"
                  ...
                  >
                    ...
                    ></i>
                    <span className="fs-6 fw-medium text-dark">
                      Eliminate surprises at the front desk
                    </span>
                  </div>
                </div>
              </div>
